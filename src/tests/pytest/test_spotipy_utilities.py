...
def test_clear_playlist_name() :
    ...
    expected_name = 'Spotify\'s Most Played All-Time [Updated Weekly]  Most Streamed  Top Played  500Mil+'
...
def test_track_ids_from_playlist() :
    ...
    user = "ivanrinaldi_"
    expected_tracks_ids = ['18lR4BzEs7e3qzc0KVkTpU', '1r1fPuhj9H4VdXr7OK6FL5', '373gDROnujxNTFa1FojYIl']
...
def test_get_track_features() :
    ...
    assert track_features == expected_track_features, "Track's features do not match"
