...
suite = context.add_expectation_suite(expectation_suite_name="preprocessed_data_expectations")
...
train_validator = context.sources.pandas_default.read_csv(conf.pro_train_set_path)
test_validator = context.sources.pandas_default.read_csv(conf.pro_test_set_path)

# Load the expectation suite
preprocessed_data_suite = context.get_expectation_suite("preprocessed_data_expectations")
